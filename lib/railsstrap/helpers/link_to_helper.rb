...
module Railsstrap
  module Helpers
    ...
    # @see http://getbootstrap.com/components/docs/4.0/dropdowns
    # @see http://getbootstrap.com/components/docs/4.0/nav
    # @see http://getbootstrap.com/components/docs/4.0/navbar-brand-image
    # @see http://getbootstrap.com/components/docs/4.0/navbar-links
