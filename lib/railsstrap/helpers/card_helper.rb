...
module Railsstrap
  module Helpers
    ...
    #   @option options [#to_s] :variant (#to_s) (:default) the variantual
    ...
    #       panel 'You accepted the Terms of service.', variant: :success
    ...
    def panel(*args, &block)
      panel = Railsstrap::Panel.new self, *args, &block
      panel.extract! :body, :variant, :title, :heading, :tag

      panel.append_class! :panel
      panel.append_class! panel.variant_class
