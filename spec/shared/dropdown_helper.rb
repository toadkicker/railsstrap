...
shared_examples_for 'the :groupable dropdown option' do
  Railsstrap::Dropdown.groupables.each do |groupable, groupable_class|
...
shared_examples_for 'the :direction dropdown option' do
  Railsstrap::Dropdown.directions.each do |direction, direction_class|
...
shared_examples_for 'the :align dropdown option' do
  Railsstrap::Dropdown.aligns.each do |align, align_class|
